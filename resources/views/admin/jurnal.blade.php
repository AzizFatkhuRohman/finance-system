...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Jurnal Umum</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            ...
                            <p class="mb-40">Berikut data <code>Jurnal umum</code> yang sudah di proses dari data transaksi yang berjalan..</p>
                            <div class="row">
