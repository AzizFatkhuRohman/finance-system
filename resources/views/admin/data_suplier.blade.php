...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Supliers</h4>
                </div>
                <!-- /Title -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">Data Supliers &nbsp; <a href="form_suplier.html"><button class="btn btn-primary btn-sm">Tambah data</button></a></h5>
