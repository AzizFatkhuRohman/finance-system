        ...
        <div class="container-fluid">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                data-feather="align-left"></i></span></span>Edit Supplier</h4>
            </div>

            <div class="row">
                <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                        <h5 class="hk-sec-title">Edit Supplier {{$data->code_supplier}}</h5>
                        <p class="mb-25">Isi form berikut dengan lengkap.</p>
                        <div class="row">
                            <div class="col-sm">
                                <form action="{{ url('suplier/' . $data->id) }}" method="post">
                                    @csrf
                                    @method('put')
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control @error('cabang') is-invalid @enderror" id="cabang"
                                                name="cabang" type="text" value="{{ old('cabang', $data->cabang) }}">
                                            @error('cabang')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
