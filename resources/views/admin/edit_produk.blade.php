                                ...
                                <form action="{{ url('produk/'.$data->id) }}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input class="form-control @error('nm_produk') is-invalid @enderror" id="nm_produk" placeholder="Nama Produk" name="nm_produk" value="{{ old('nm_produk', $data->nama_produk) }}" type="text">
                                            @error('nm_produk')
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input class="form-control @error('kd_produk') is-invalid @enderror" id="kd_produk" placeholder="Kode Produk" name="kd_produk" value="{{ old('kd_produk', $data->kode_produk) }}" type="text">
                                            @error('kd_produk')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="form-control custom-select @error('satuan') is-invalid @enderror" name="satuan">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input class="form-control @error('harga') is-invalid @enderror" name="harga" value="{{ old('harga', $data->harga) }}" type="text">
                                            @error('harga')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>              
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-10">
                                            ...
                                            <input class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" value="{{ old('stok', $data->stok) }}" type="text">
                                            @error('stok')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
