...
<body>
    ...
    <!-- KIRI -->
    <div style="width: 60%;">
        <img src="{{ public_path('dist/img/logo_dwi.png') }}" width="130" alt="Logo" style="margin-bottom: 10px;">
        <h5 style="margin: 0;">PT. Dwi Lestari Utama Sinergi</h5>
    ...
    <div style="width: 35%; text-align: right;">
        ...
        <p style="margin: 0;">Date: {{ $penjualan->tgl_transaksi }}</p>
        <p style="margin: 0;">Quotation No: {{ $penjualan->kode_transaksi }}</p>
        <p style="margin: 0;">Customer #: {{ $penjualan->customer->code_customer }}</p>
    </div>
</div>
